...
1. 安装 pangolin
    ...
    1. ERROR1:
      ![libpng12-dev has no installation candidate](/illustration/libpng12-dev-error.png)

        解决方法: 

        ![libpng12-dev 解决方案](/illustration/libpng12-dev-error-solution.png)
    ...
    2. ERROR2:
      ![xkbcommon not found](/illustration/xkbcommon-not-found.png)
        ...
        ![xkbcommon not found 解决方案](/illustration/xkbcommon-not-found-solution.png)
