...
![TCP header format](/illustration/en/tcp-head.png)
...
![TCP 3-Way Handshake process](/illustration/en/tcp-handshake-process.png)
...
1.  First handshake
    ...
    ![TCP first handshake message](/illustration/en/tcp-first-handshake.png)
...
2.  Second handshake
    ...
    ![TCP Second handshake message](/illustration/en/tcp-second-handshake.png)
...
3.  Third handshake
    ...
    ![TCP third handshake message](/illustration/en/tcp-third-handshake.png)
...
![TCP 3-Way Handshake to avoid historical connections](/illustration/en/tcp-avoid-old-duplicate-connection.png)
...
![4-Way Handshake merged into 3-Way Handshake](/illustration/en/tcp-handshake-merge.png)
:::

## 4-Way Handshake
### Handshake Process
![TCP 4-Way Handshake](/illustration/en/tcp-handwave-process.png)
